...
30:["Wépion B","Aische B","FCO Namur","Sauvenire A","Boninne A","Loyers B","Mazy A","Ligny B","Leuze A","Grand-Leez B","Emines B","Naninne B","St-Germain","Petit-Waret A","Rhisnes B","Temploux"]
};
...
function gen() { 
    ...
    if(M[journeeActuelle]) { 
        M[journeeActuelle].forEach((m, i) => { 
            let cDom = m.dom === "FCO Namur" ? "color:#ffff00!important;font-weight:bold!important;" : "color:#ffffff!important;";
            let cExt = m.ext === "FCO Namur" ? "color:#ffff00!important;font-weight:bold!important;" : "color:#ffffff!important;";
            h += `<div class="match-card ${m.dom === "FCO Namur" || m.ext === "FCO Namur" ? "match-fco-namur" : ""}"><span class="equipe domicile" style="${cDom}">${m.dom}</span><div class="score-container"><input type="tel" class="score-input" style="width:28px!important;height:22px!important;font-size:12px!important;text-align:center!important;background:#2d2d2d!important;color:#fff!important;border:1px solid #444!important;border-radius:4px!important;padding:0!important;" value="${m.sD}" onchange="enregistrerScore(${i}, 'dom', this.value)"><input type="tel" class="score-input" style="width:28px!important;height:22px!important;font-size:12px!important;text-align:center!important;background:#2d2d2d!important;color:#fff!important;border:1px solid #444!important;border-radius:4px!important;padding:0!important;" value="${m.sE}" onchange="enregistrerScore(${i}, 'ext', this.value)"></div><span class="equipe exterieur" style="${cExt}">${m.ext}</span></div>`; 
        }); 
    } 
